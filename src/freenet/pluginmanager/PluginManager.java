...
//		installDir = pmconfig.getString("installdir");
	...
	static {
		...
		addOfficialPlugin("XMLSpider", false, 45, true, new FreenetURI("CHK@34ZgEgYVP~XBNLa1Rc5eZvxOlJb1zHa-i1oQ-IfCnnE,pix6a--wquyTKtuMNnrKZba8AkC-dfra5CWMeMjp-jU,AAIC--8/XMLSpider.jar"));
		...
		addOfficialPlugin("Spider", false, 46, false, new FreenetURI("CHK@G9n3Ew8pA2oXvOnCMyRcc4GBPPSLHSppe2b5Xoa1VMQ,pGDhSFGBeznaMrfV4wLC4bnpQOfjop6c0dL2NPBCkNw,AAIC--8/Spider.jar"));
		} catch (MalformedURLException e) {
